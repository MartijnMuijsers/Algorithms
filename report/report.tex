...
\begingroup
\tikzset{every picture/.style={scale=0.45,radius=0.05,line width=0.4}}%
\begin{figure}[ht!]
\centering
...
The higher the value of $k$ is chosen, the more gaps there may fall in the result. A low value of $k$ might however allow wrong solutions, such as a curve in the shape of a letter M getting its two pillar bottom points connected by a segment.
