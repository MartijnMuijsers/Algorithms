...
%TODO Defining a function without explaining its purpose is useless. Write something like "After that, magic happens using a likelihood function that does X. Two likelihoods functions are given below:"
...
%TODO Explain parameter $q$ and $t$.
\begin{enumerate}
...
%TODO Why are the lines intersecting or too long? This "fact" is not obvipus from the above description.
