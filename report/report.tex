...
Delaunay triangulation can also be used to create a relatively small set of edges for the third problem, after which a recilinear spanning graph or straight lines can be determined between points. These straight lines can then be connected to from a road network.\\
...
%TODO: Remove all below this point for interim report
